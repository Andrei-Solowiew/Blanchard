document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelectorAll('.catalog__accordion-name').forEach(function(catalog__accordion_name){
    catalog__accordion_name.addEventListener('click', function(event) {
      ...
      document.querySelectorAll(".catalog__accordion-name").forEach(function(catalog__accordion_link) {
        catalog__accordion_link.classList.remove("catalog__accordion-name_active");
      });   
